...
import shadowsocks
from shadowsocks import common, lru_cache, cryptor
...
class auth_chain_a(auth_base):
    ...
    def pack_auth_data(self, auth_data, buf):
        ...
        encryptor = cryptor.Cryptor(to_bytes(base64.b64encode(self.user_key)) + self.salt, 'aes-128-cbc', b'\x00' * 16)
        ...
        self.encryptor = cryptor.Cryptor(to_bytes(base64.b64encode(self.user_key)) + to_bytes(base64.b64encode(self.last_client_hash)), 'rc4')
    ...
    def server_post_decrypt(self, buf):
        ...
        if not self.has_recv_header:
            ...
            encryptor = cryptor.Cryptor(to_bytes(base64.b64encode(self.user_key)) + self.salt, 'aes-128-cbc')
    ...
    def client_udp_pre_encrypt(self, buf):
        ...
        encryptor = cryptor.Cryptor(to_bytes(base64.b64encode(self.user_key)) + to_bytes(base64.b64encode(md5data)), 'rc4')
    ...
    def server_udp_pre_encrypt(self, buf, uid):
        ...
        md5data = hmac.new(mac_key, authdata, self.hashfunc).digest()
        rand_len = self.udp_rnd_data_len(md5data, self.random_server)
        encryptor = cryptor.Cryptor(to_bytes(base64.b64encode(user_key)) + to_bytes(base64.b64encode(md5data)), 'rc4')
        out_buf = encryptor.encrypt(buf)
